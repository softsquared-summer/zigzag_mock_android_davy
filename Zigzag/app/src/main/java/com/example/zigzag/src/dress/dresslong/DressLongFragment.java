...
public class DressLongFragment extends Fragment implements MyRecyclerItemsViewAdapter.OnItemClickListener, DressLongFragmentView {
    ViewGroup viewGroup;
    ...
    private DressLongService dressLongService;

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        dressLongService = new DressLongService(this);
    }
    ...
    void initView(View view) {
        mItemsRecyclerView = viewGroup.findViewById(R.id.rv_dress_long);
