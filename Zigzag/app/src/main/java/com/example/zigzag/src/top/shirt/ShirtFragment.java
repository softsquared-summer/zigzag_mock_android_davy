...
public class ShirtFragment extends Fragment implements MyRecyclerItemsViewAdapter.OnItemClickListener, ShirtFragmentView {
    ViewGroup viewGroup;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        shirtService = new ShirtService(this);
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_top_shirt, container, false);
    ...
    void initView(View view) {
        mItemsRecyclerView = viewGroup.findViewById(R.id.rv_top_shirt);
