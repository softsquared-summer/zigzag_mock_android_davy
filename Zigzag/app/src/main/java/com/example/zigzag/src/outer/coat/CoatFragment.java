...
public class CoatFragment extends Fragment implements MyRecyclerItemsViewAdapter.OnItemClickListener, CoatFragmentView {
    ViewGroup viewGroup;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        coatService = new CoatService(this);
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_outer_coat, container, false);
    ...
    void initView(View view) {
        mItemsRecyclerView = viewGroup.findViewById(R.id.rv_outer_coat);
