package com.example.zigzag.src.outer.all.models;

import com.google.gson.annotations.SerializedName;

import java.util.ArrayList;

public class OuterAllResponse {

    public class OuterAllResult{
    ...
    private ArrayList<OuterAllResult> outerAllResults;
    ...
    public ArrayList<OuterAllResult> getOuterAllResults() {
        return outerAllResults;
    }
}