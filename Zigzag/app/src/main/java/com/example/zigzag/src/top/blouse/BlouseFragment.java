...
public class BlouseFragment extends Fragment implements MyRecyclerItemsViewAdapter.OnItemClickListener, BlouseFragmentView {
    ViewGroup viewGroup;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        blouseService = new BlouseService(this);
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_top_blouse, container, false);
    ...
    void initView(View view) {
        mItemsRecyclerView = viewGroup.findViewById(R.id.rv_top_blouse);
