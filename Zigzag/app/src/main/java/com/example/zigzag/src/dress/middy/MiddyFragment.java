...
public class MiddyFragment extends Fragment implements MyRecyclerItemsViewAdapter.OnItemClickListener, MiddyFragmentView {
    ViewGroup viewGroup;
    ...
    private MiddyService middyService;

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        middyService = new MiddyService(this);
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_dress_middy, container, false);
    ...
    void initView(View view) {
        mItemsRecyclerView = viewGroup.findViewById(R.id.rv_dress_middy);
