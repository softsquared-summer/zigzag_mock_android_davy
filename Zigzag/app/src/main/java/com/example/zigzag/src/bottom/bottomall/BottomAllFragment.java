...
public class BottomAllFragment extends Fragment implements MyRecyclerItemsViewAdapter.OnItemClickListener, BottomAllFragmentView {
    ViewGroup viewGroup;
    ...
    private BottomAllService bottomAllService;

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        bottomAllService = new BottomAllService(this);
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_bottom_all, container, false);
    ...
    void initView(View view) {
        mItemsRecyclerView = viewGroup.findViewById(R.id.rv_bottom_all);
